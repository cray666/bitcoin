...
[blockchain_go](https://github.com/Jeiwan/blockchain_go)是github上使用go语言实现比特币的一个项目，主要涉及到工作量证明，比特币地址，数字签名，交易，数据库存储，网络等方面知识，本文章主要记录自己学习`blockchain_G`o中遇到的一些问题和总结的心得。
